...
export default function WhileBlock({ block_ }: { block_: Block }) {
  ...
  return (
    <>
      <animated.div
        className="border absolute bg-yellow-300 w-fit h-fit p-4 touch-none z-10"
        {...bind()}
        style={{ x, y, top: initialY, left: initialX }}
        ref={ref}
      >
        <div className="flex">
          <h1 className="mr-2">While</h1>
